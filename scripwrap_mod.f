!=========================================================================
!     This module defines the global variables for running scripwrap_mod.f.
!                                                  
...
!-----------------------------------------------------------------------
      ...
      character(char_len), dimension(5) :: swan_coord, bath_file
      character(char_len), dimension(5) :: cartesian
      character(char_len), dimension(5)  :: wrf_grids 

      integer(int_kind) :: iunit
      integer(int_kind) :: Ngrids_roms, Ngrids_swan, Ngrids_wrf
      integer(int_kind),dimension(5) :: Numx_swan_temp, Numy_swan_temp
